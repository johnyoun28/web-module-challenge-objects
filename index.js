...
console.log(createMenuItem("Large Coke", 3, "Drinks"));
console.log(createMenuItem("Tacos", 9, "Dinner"));
...
let burgerDiscount = {
  ...
  discount: function (str) {
    if (str === "teacher" || str === "student") {
      return burgerDiscount.price * 0.75;
    } else if (str === "public") {
      return burgerDiscount.price * 0.9;
    }
  },
};
console.log(burgerDiscount.discount("student"));
...
const myReview = {
  name: "John",
  rating: 1,
  feedback: "Terrible experience & disgusting food",
};
...
function getLastReview(array) {
  return `${array[array.length - 1].name} gave the restaurant a rating ${
